...
namespace CompactExifLib
{
    public class ExifData
    {
        ...
        static private uint ReadUInt32BE(byte[] Data, int StartIndex)
        {
      ...
      0x54DE5729, 0x23D967BF, 0xB3667A2E, 0xC4614AB8, 0x5D681B02, 0x2A6F2B94, 0xB40BBE37, 0xC30C8EA1, 0x5A05DF1B, 0x2D02EF8D };
        ...
        public static ImageType CheckStreamTypeAndCompatibility(Stream StreamToBeChecked, bool throwerror = true)
        {
        ...
        //JJ
        public void SaveJpeg(Stream SourceStream, Stream DestStream)
        {
